        ...
        <div className="card hero-panel" style={{ padding: 28 }}>
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p className="section-copy" style={{ fontSize: '1.05rem' }}>
              ...
              Every visit is built to feel organized, motivating, and easy to commit to.
            </p>
            ...
            <div className="stat-grid" style={{ marginTop: 28 }}>
              ...
              <div className="stat-card">
                <strong style={{ display: 'block', fontSize: '1.2rem' }}>5 AM - 11 PM</strong>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              <div className="card" style={{ padding: 18, background: 'rgba(5,5,5,0.72)' }}>
                ...
                <p className="muted" style={{ margin: '6px 0 0' }}>
                  Simple plans, real value, and a join process that feels clear from the first click.
                </p>
              </div>
              <div className="card" style={{ padding: 18, background: 'rgba(5,5,5,0.72)' }}>
                <strong>Book a free trial today</strong>
                <p className="muted" style={{ margin: '6px 0 0' }}>
                  WhatsApp, call, or submit the form to get a quick response from our team.
                </p>
              </div>
            </div>
          </div>
